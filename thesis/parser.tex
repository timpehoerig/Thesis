...
The implementations for types and expressions differs a bit. Because there are different types and different expressions, for both first a plain class with no fields is defined \inl{Type} and \inl{Expressions} from which then all the different kinds of types or expressions inherit.
